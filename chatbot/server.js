...
app.post('/api/chat', async (req, res) => {
  ...
  try {
    ...
    const systemPrompt = `You are a helpful documentation assistant for a BookStack knowledge base at ${BOOKSTACK_BASE_URL}.
Answer questions using the provided documentation context. The context may include markdown pages or Book and Chapter Table of Contents.

Rules:
- Give thorough and accurate answers based on the documentation context.
- If the docs don't have the answer, say so clearly. Do not hallucinate.
